...
const PALETTE_ITEMS: PaletteItem[] = [
  ...
  {
    id: 'mod-gstr1',
    title: 'GSTR-1 Tax Portal Return & Upload',
    subtitle: 'Government-ready Table 4 B2B, Table 7 B2CS, Table 9B, & Table 12 HSN Portal JSON',
    category: 'MODULES',
    href: '/gst/gstr-1',
    icon: FileCode,
    keywords: ['gstr1', 'gst', 'tax', 'returns', 'government', 'json', 'export', 'compliance', 'b2b', 'hsn'],
    badge: 'GST Filing',
    badgeColor: 'indigo',
  },
  {
    id: 'mod-gstr3b',
    title: 'GSTR-3B Return Preparation Assistant',
    subtitle: 'Table 3.1 Outward Liability, Table 4 Eligible ITC & Rule 88A Electronic Credit Ledger setoff',
    category: 'MODULES',
    href: '/gst/gstr-3b',
    icon: Calculator,
    keywords: ['gstr3b', '3b', 'tax', 'return', 'itc', 'rule 88a', 'setoff', 'challan', 'pmt06', 'gst'],
    badge: 'Monthly 3B',
    badgeColor: 'emerald',
  },
  {
    ...
    subtitle: 'Cross-match bank statement CSV with General Ledger bank journal entries and audit variance',
    category: 'MODULES',
    href: '/accounting/reconciliation',
    icon: Landmark,
    keywords: ['bank', 'reconciliation', 'brs', 'statement', 'ledger', 'audit', 'variance', 'cheque', 'neft'],
    badge: 'Audit',
    badgeColor: 'emerald',
  },
  {
    id: 'mod-credit-notes',
    title: 'Credit Notes & Sales Returns Register (Rule 53)',
    subtitle: 'Statutory GST credit vouchers, item restock, and output tax reversals',
    category: 'MODULES',
    href: '/invoices/credit-notes',
    icon: RotateCcw,
    keywords: ['credit note', 'sales return', 'refund', 'rule 53', 'reversal', 'discount', 'gst'],
    badge: 'Rule 53',
    badgeColor: 'indigo',
  },
  {
    id: 'mod-eway-bills',
    title: 'E-Way Bills Register & Dispatch Control (Rule 138)',
    subtitle: 'Statutory electronic waybills for movement of goods exceeding ₹50,000 threshold',
    category: 'MODULES',
    href: '/invoices/eway-bills',
    icon: Truck,
    keywords: ['eway', 'bill', 'transporter', 'vehicle', 'rule 138', 'dispatch', 'validity', 'road'],
    badge: 'Rule 138',
    badgeColor: 'emerald',
  },
  {
    id: 'mod-delivery-challans',
    title: 'Delivery Challans & Non-Sale Movement (Rule 55)',
    subtitle: 'Transport of goods on approval, job work, demonstrations, with 1-click invoice conversion',
    category: 'MODULES',
    href: '/inventory/challans',
    icon: Truck,
    keywords: ['delivery', 'challan', 'rule 55', 'job work', 'approval', 'transport', 'goods'],
    badge: 'Rule 55',
    badgeColor: 'indigo',
  },
  {
    id: 'mod-customer-aging',
    title: 'Accounts Receivable & Customer Aging Analysis',
    subtitle: 'Debtors credit tracking (0-30, 31-60, 61-90, 90+ days) and automated WhatsApp payment notices',
    category: 'MODULES',
    href: '/customers/aging',
    icon: Clock,
    keywords: ['aging', 'debtors', 'receivable', 'customers', 'khata', 'overdue', 'whatsapp', 'reminder'],
    badge: 'Debtors',
    badgeColor: 'amber',
  },
  {
    id: 'mod-vendor-payables',
    title: 'Accounts Payable & Vendor Aging Analysis',
    subtitle: 'Supplier bills outstanding, credit periods, payment aging buckets, and cash outflow planning',
    category: 'MODULES',
    href: '/inventory/payables',
    icon: CreditCard,
    keywords: ['payables', 'creditors', 'vendors', 'suppliers', 'bills', 'aging', 'payment', 'due'],
    badge: 'Creditors',
    badgeColor: 'amber',
  },
  {
