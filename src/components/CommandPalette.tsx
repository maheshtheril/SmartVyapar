...
const PALETTE_ITEMS: PaletteItem[] = [
  ...
  {
    id: 'act-new-voucher',
    title: 'Record Accounting Voucher',
    subtitle: 'Payment, receipt, contra transfer, or journal entry',
    category: 'ACTIONS',
  ...
  },
  {
    ...
    subtitle: 'Prepare and export GST outward sales JSON for portal upload',
    category: 'MODULES',
    href: '/gst/gstr-1',
    icon: FileCode,
  ...
  {
    id: 'mod-gstr3b',
    title: 'GST Returns (GSTR-3B)',
    subtitle: 'Monthly tax summary, liability calculation, and ITC status',
    category: 'MODULES',
    href: '/gst/gstr-3b',
    icon: Calculator,
  ...
  },
  {
    ...
    subtitle: 'Process refunds, sales returns, and adjust customer balances',
    category: 'MODULES',
  ...
  {
    id: 'mod-eway-bills',
    title: 'E-Way Bills & Dispatch',
    subtitle: 'Generate waybills for transport of goods',
    category: 'MODULES',
